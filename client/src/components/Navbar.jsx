...
const Navbar = () => {
  ...
  const currentCollegeName =
    resolvedCollege?.shortName || resolvedCollege?.name || resolvedCollege?.code || "Set College";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-6">
            ...
            {user && <div className="hidden md:flex items-center h-6 w-px bg-gray-200 mx-2" />}
            ...
            {user && (
              ...
              >
                <div className="w-10 h-10 rounded-xl overflow-hidden flex items-center justify-center bg-gray-100 border border-gray-200">
                  {currentCollegeLogo ? (
                    <img
                ...
                <span className="text-md font-medium text-gray-600 group-hover:text-black transition-colors max-w-[140px] truncate">
                  {currentCollegeName}
                </span>
              </button>
            )}
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <NavLink to="/home/wishlist" className={navLinkClass}>
              Wishlist
            </NavLink>
            ...
            {/* Search Trigger (Mock) */}
            <button className="text-gray-400 hover:text-black transition" aria-label="Search">
              <Search size={18} />
            </button>
            ...
            {!user ? (
              ...
              <div className="relative" ref={profileRef}>
                ...
                {profileOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 ring-1 ring-black ring-opacity-5 origin-top-right">
          ...
          <div className="md:hidden flex items-center">
            <button onClick={() => setOpen(!open)} className="text-gray-600 hover:text-black" aria-label="Open menu">
